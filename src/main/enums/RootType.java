...
public enum RootType {
    ...
    public HashSet<Point> getRoots(JavmosGUI gui, Function function, double minDomain, double maxDomain) {
        ...
        for (double k = (minDomain / gui.getZoom() * gui.getDomainStep()); k <= (maxDomain / gui.getZoom() * gui.getDomainStep()); k += 0.005 * step) {
